...
function getIdGeneratorFunction(startFrom) {
  function getIdGenerator() {
    getIdGenerator.count += 1;
    return getIdGenerator.count;
  }
  getIdGenerator.count = startFrom - 1;
